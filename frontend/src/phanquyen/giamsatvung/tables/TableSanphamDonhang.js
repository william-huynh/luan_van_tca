...
const TableSanphamDonhang = ({
  dsSanpham = [],
  handleChangeSlSanpham,
  dl1Id,
}) => {
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <Input
                            ...
                            value={row?.soluongpp}
                            onChange={(e) =>
                              handleChangeSlSanpham(e, row._id, dl1Id)
                            }
                          />
                        </TableCell>
                        <TableCell align="right">
                          {formatMoney(parseInt(row?.soluongpp) * row?.gia)} vnđ
                        </TableCell>
                      </TableRow>
                    );
                  })}
...
export default TableSanphamDonhang;
