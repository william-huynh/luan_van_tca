...
const TongQuan = (props) => {
  ...
  const fetchData = async () => {
    ...
    const data = await apiDaily1.tongquan(daily1._id);
    setCounts(data);
    setLoading(false);
  };
  ...
  return (
    <Wrapper>
      <Header title="Tổng quan" arrOfLinks={links} vaitro="daily1" />
      <Content>
        <div className="row mb-4">
          <div className="col-lg-3">
            <Card onClick={() => props.history.push("/daily1/sanpham")}>
              <CardContent>
                <TextInfo>
          ...
          <div className="col-lg-3">
            <Card onClick={() => props.history.push("/daily1/vattu")}>
              <CardContent>
                <TextInfo>
          ...
          <div className="col-lg-3">
            <Card onClick={() => props.history.push("/daily1/nguyenlieu")}>
              <CardContent>
                <TextInfo>
          ...
          <div className="col-lg-3">
            <Card onClick={() => props.history.push("/daily1/congcu")}>
              <CardContent>
                <TextInfo>
        ...
        <div className="row">
          <div className="col-lg-3">
            <Card onClick={() => props.history.push("/daily1/daily2")}>
              <CardContent>
                <TextInfo>
          ...
          <div className="col-lg-3">
            <Card onClick={() => props.history.push("/daily1/hodan")}>
              <CardContent>
                <TextInfo>
          ...
          <div className="col-lg-3">
            <Card onClick={() => props.history.push("/daily1/donhang")}>
              <CardContent>
                <TextInfo>
