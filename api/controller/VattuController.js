...
// them vat tu
module.exports.themvattu = async (req, res) => {
...
// sua vat tu
module.exports.suavattu = async (req, res) => {
...
module.exports.laydsvattu = async (req, res) => {
...
module.exports.laytt1vattu = async (req, res) => {
  try {
    const vattu = await Vattu.findById(req.params.id);
    if (vattu) {
      res.send({ vattu, success: true });
...
// Xoa 1 vattu
module.exports.xoavattu = async (req, res) => {
  try {
...
// Xoa nhieu vattu
module.exports.xoanhieuvattu = async (req, res) => {
