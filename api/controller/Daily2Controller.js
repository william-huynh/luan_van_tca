...
// chinh sua dai ly 2
module.exports.chinhsuadaily2 = async (req, res) => {
...
module.exports.laydsdaily2 = async (req, res) => {
  try {
...
module.exports.laythongtin1daily = async (req, res) => {
  try {
    const daily2 = await Daily2.findById(req.params.id)
      .populate({
...
// xoa 1 daily2
module.exports.xoa1daily2 = async (req, res) => {
  try {
    // xoa user
    const daily2 = await Daily2.findById(req.params.id);
    if (daily2.user) {
...
module.exports.xoanhieuhodanthuocdaily2 = async (req, res) => {
...
module.exports.laydsDL2DL1 = async (req, res) => {
  try {
...
// daily 2 them ho dan
module.exports.daily2themhodan = async (req, res) => {
  const { daily2Id, arrayOfId } = req.body;
  try {
    const daily2 = await Daily2.findById(daily2Id);
    for (const item of arrayOfId) {
...
module.exports.laydsphanohatcongcudaily2 = async (req, res) => {
  try {
...
module.exports.laydsphanphatvattudaily2 = async (req, res) => {
  try {
    let { dsphanphat } = await Daily2.findById(req.params.daily2Id)
      .select("dsphanphat")
      .populate({
...
module.exports.lay1phanphatthuocdaily2 = async (req, res) => {
  try {
...
module.exports.laydscongcuthuocdaily2 = async (req, res) => {
  try {
...
module.exports.laydsvattuthuocdaily2 = async (req, res) => {
  try {
...
module.exports.laythongtindaily2byUserId = async (req, res) => {
  try {
...
module.exports.themdaily2vaodsdaily2cuadaily1 = async (req, res) => {
...
module.exports.laydsdonhangthuocdaily2 = async (req, res) => {
  try {
...
module.exports.laydshodanthuocdaily2 = async (req, res) => {
  try {
...
module.exports.laydsSUBdonhangthuocdaily2 = async (req, res) => {
  try {
...
module.exports.laydsspthuocdaily2 = async (req, res) => {
  try {
...
module.exports.laydsnguyenlieuthuocdaily1 = async (req, res) => {
  try {
...
module.exports.laydsdonhangchuahienthi = async (req, res) => {
  try {
    let { donhang } = await Daily2.findById(req.params.daily2Id)
      .select("donhang")
      .populate("donhang");
...
module.exports.laydsSUBdonhangcuadonhangcomacuthe = async (req, res) => {
  try {
    let { subdonhang } = await Daily2.findById(req.params.daily2Id)
      .select("subdonhang")
      .populate({
