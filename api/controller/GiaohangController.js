...
module.exports.hodangiaohangchodaily2 = async (req, res) => {
...
// dai ly 2 xac nhan
module.exports.daily2xacnhan = async (req, res) => {
  try {
...
module.exports.daily2giaodaily1 = async (req, res) => {
...
// dai ly 1 xac nhan
module.exports.daily1xacnhan = async (req, res) => {
  try {
    const gh = await Giaohang.findById(req.params.giaohangId);
...
module.exports.daily1giaohangchogsv = async (req, res) => {
...
// gsv xac nhan
module.exports.gsvxacnhan = async (req, res) => {
  try {
    const gh = await Giaohang.findById(req.params.giaohangId);
...
module.exports.gsvgiaohangbpkd = async (req, res) => {
...
// bophankd xac nhan
module.exports.bpkdxacnhan = async (req, res) => {
  try {
    const gh = await Giaohang.findById(req.params.giaohangId);
...
// get single giaohang
module.exports.laythongtingiaohang = async (req, res) => {
  try {
...
module.exports.laydsgiaohanghodandendaily2 = async (req, res) => {
  try {
...
module.exports.laydsgiaohangDIcuadaily2dendaily1 = async (req, res) => {
  try {
...
module.exports.laydsgiaohangDENcuadaily1vadaily1 = async (req, res) => {
  try {
...
module.exports.laydsgiaohangDIcuadaily1dengsv = async (req, res) => {
  try {
    let dsgiaohang = await Giaohang.find({
...
module.exports.laydsgiaohangDENcuadaily1vagsv = async (req, res) => {
  try {
...
module.exports.laydsgiaohangDIcuagsvvabpkd = async (req, res) => {
  try {
    let dsgiaohang = await Giaohang.find({
...
module.exports.laydsgiaohangDENcuagsvvabpkd = async (req, res) => {
  try {
