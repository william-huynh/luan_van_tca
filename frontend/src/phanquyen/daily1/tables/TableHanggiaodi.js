...
import { headCellsGiaohangDi } from "./headCells";
import styled from "styled-components";

const TableHanggiaodi = ({
  dsGiaohang = [],
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <Link to={`/daily1/hanggiaodi/chitiet/${row._id}`}>
                            {row.donhang.ma}
                          </Link>
                        </TableCell>
                        <TableCell align="right">
                          {row?.donhang.from.giamsatvung.ten}
                        </TableCell>
                        ...
                        <TableCell align="right">
                          {!row.xacnhan ? (
                            ...
                            <Badge className="success">Đã xác nhận</Badge>
                          )}
                        </TableCell>

                        <TableCell align="right">
                          {!row.ngaynhan ? "Đang chờ..." : row.ngaynhan}
                        </TableCell>
                      </TableRow>
                    );
                  })}
...
export default TableHanggiaodi;
