...
// them ho dan
module.exports.themhodan = async (req, res) => {
  const {
    daidien,
    xa,
    tinh,
...
// chinh sua hodan
module.exports.chinhsuahodan = async (req, res) => {
  const {
    daidien,
    matkhau,
    sdt,
...
module.exports.laydshodanthuoclangnghe = async (req, res) => {
  try {
...
module.exports.laydshodancodaily2null = async (req, res) => {
  try {
...
// search hodan
module.exports.timkiemhodan = async (req, res) => {
...
// xoa 1 ho dan
module.exports.xoa1hodan = async (req, res) => {
  try {
    // xoa user
    const hodan = await Hodan.findById(req.params.id);
    if (hodan.user) {
...
// xoa nhieu` ho dan
module.exports.xoanhieuhodan = async (req, res) => {
...
module.exports.laytt1hodan = async (req, res) => {
  try {
    const hodan = await Hodan.findById(req.params.id)
      .populate("donhang")
      .populate({
...
module.exports.lay1phanphatthuochodan = async (req, res) => {
  try {
...
module.exports.laytt1hodanbyUserId = async (req, res) => {
  try {
...
module.exports.laydsphanphatthuochodan = async (req, res) => {
  try {
...
module.exports.laydsphanphatcongcuthuochodan = async (req, res) => {
  try {
    let { dsphanphat } = await Hodan.findById(req.params.hodanId)
      .select("dsphanphat")
      .populate({
...
module.exports.laydsphanphatvattuthuochodan = async (req, res) => {
  try {
...
module.exports.laydscongcuthuochodan = async (req, res) => {
  try {
...
module.exports.laydsnguyenlieuthuochodan = async (req, res) => {
  try {
...
module.exports.laydsvattuthuochodan = async (req, res) => {
  try {
    const { dsnguyenlieu } = await Hodan.findById(req.params.hodanId)
      .select("dsvattu")
      .populate({
...
module.exports.laydsdonhangthuochodan = async (req, res) => {
  try {
...
module.exports.hodanxacnhandonhang = async (req, res) => {
  try {
...
// them vat tu hu loi
module.exports.themvattubiloi = async (req, res) => {
...
// doi mat khau hodan
module.exports.doimatkhauhodan = async (req, res) => {
...
module.exports.hodanbaocaodonhang = async (req, res) => {
