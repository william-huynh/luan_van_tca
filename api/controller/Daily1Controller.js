...
// them dai ly
module.exports.themdaily1 = async (req, res) => {
...
// chinh sua dai ly
module.exports.chinhsuadaily1 = async (req, res) => {
...
module.exports.laydanhsachdaily1 = async (req, res) => {
  try {
...
module.exports.danhsachdaily1khongbpkd = async (req, res) => {
  try {
...
module.exports.laythongtin1daily1 = async (req, res) => {
  try {
    const daily1 = await Daily1.findById(req.params.id)
      .populate({
...
// xoa 1 dai ly 1
module.exports.xoadaily1 = async (req, res) => {
  try {
    // xoa user
    const daily1 = await Daily1.findById(req.params.id);
    if (daily1.user) {
...
// xoa nhieu` daily 1
module.exports.xoanhieudaily1 = async (req, res) => {
...
module.exports.laythongtindaily1byUserId = async (req, res) => {
  try {
...
// daily1 them daily2
module.exports.themdaily2 = async (req, res) => {
...
module.exports.xoanhieudaily2 = async (req, res) => {
...
module.exports.danhsachphanphatcongcudaily1 = async (req, res) => {
  try {
...
module.exports.danhsachphanphatvattudaily1 = async (req, res) => {
  try {
    let { dsphanphat } = await Daily1.findById(req.params.daily1Id)
      .select("dsphanphat")
      .populate({
...
module.exports.lay1phanphatthuocdaily1 = async (req, res) => {
  try {
...
module.exports.danhsachcongcudaily1 = async (req, res) => {
  try {
...
module.exports.danhsachvattudaily1 = async (req, res) => {
  try {
...
module.exports.danhsachhodandaily1 = async (req, res) => {
  try {
...
// Duyệt hộ dân
module.exports.duyethodan = async (req, res) => {
  try {
...
module.exports.danhsachdonhangdaily1 = async (req, res) => {
  try {
...
module.exports.danhsachdaily2thuocdaily1 = async (req, res) => {
  try {
...
module.exports.danhsachSUBdonhangdaily1 = async (req, res) => {
  try {
...
module.exports.danhsachsanphamdaily1 = async (req, res) => {
  try {
...
module.exports.danhsachvattuthuocdaily1 = async (req, res) => {
  try {
...
module.exports.danhsachnguyenlieuthuocdaily1 = async (req, res) => {
  try {
...
module.exports.danhsachcongcuthuocdaily1 = async (req, res) => {
  try {
...
module.exports.laydanhsachHDDHchuaduyet = async (req, res) => {
  try {
    // Hodan
...
module.exports.laydsSUBdonhangcomacuthe = async (req, res) => {
  try {
    let { subdonhang } = await Daily1.findById(req.params.daily1Id)
      .select("subdonhang")
      .populate({
